    ...
    <div class="card card-primary card-outline card-outline-tabs">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
					...
					<div class="col-sm-5">
                   <center> <div class="nav-link">Block List</div></center>
					</div>
					<div class="col-sm-4">
					...
					<div class="col-sm-1">
						<td>
<button type="button" class="btn btn-block btn-secondary" data-toggle="modal" data-target="#addblock"><i class="fa fa-plus"></i> Add</button>
</td>
					</div>
                </ul>
              </div>
                      ...
                      <tr id="arrayorder_<?php echo $manageblockslist->id?>">
                        ...
                        @endif     
						 <td>
                                ...
                                <button type="button" data-toggle="modal" data-target="#edit{{ $manageblockslist->id }}"  class="col-md-5 btn btn-block btn-info"><i class="fa fa-edit"> Edit</i></button>&nbsp;&nbsp;
                          </td>
                          <td>
						<a href="rooms/{{ $manageblockslist->id }}" type="button"class="col-md-5 btn btn-block btn-info"><i class="fa fa-eye"> Rooms</i></a>

                            
                                <!-- <button type="button" data-toggle="modal" data-target="#deleteproduct{{ $manageblockslist->id }}"  class="col-md-4 btn btn-block btn-danger"><i class="fa fa-trash"></i></button> -->
                            </div>
                        </td>
						</tr>
