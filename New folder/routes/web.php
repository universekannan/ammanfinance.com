...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::post('/add_plan', 'App\Http\Controllers\MerchantController@addPlan');
    Route::post('/edit_plan', 'App\Http\Controllers\MerchantController@editPlan');
    Route::post('/delete_plan', 'App\Http\Controllers\MerchantController@deletePlan');
    Route::post('/plan_sorting', 'App\Http\Controllers\MerchantController@planSorting');
    Route::get('/manage_plan', 'App\Http\Controllers\MerchantController@managePlan');
	
    Route::get('/test', 'App\Http\Controllers\TestController@manageTest');
...
//Pharmacy//
         ...
         Route::post('/pharmacy/delete_product', 'App\Http\Controllers\ProductsController@deleteProduct');
//category//
