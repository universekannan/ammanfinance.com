...
/******   Manage Users  Start ******/
 ...
 public function manageusers(){
	$manageusers = DB::table('user_permission')->select('user_permission.*','users.*','user_groups.*','user_permission.id as userID')
        ...
        $userrole = DB::table('user_groups')->where('status', '=','1')->orderBy('id','Asc')->get();
...
public function roles(Request $request){
        ...
        $roles = DB::table('user_groups')->insert([
