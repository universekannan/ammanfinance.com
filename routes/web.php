...
//Collection
    ...
    Route::get('/goldcollection/{from}/{to}', 'App\Http\Controllers\ReportsController@manageGoldCollection');
    Route::get('/depositscollection/{from}/{to}', 'App\Http\Controllers\ReportsController@manageDepositsCollection');
