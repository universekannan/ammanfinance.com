                        ...
                        <div class="modal-dialog">
                           <div class="modal-content">
                              ...
                              <div class="modal-body">
                                 <form action="{{url('/edit_activation')}}" onsubmit="return validate_amount(event,{{ $manageactivationlist['id'] }})" method="post" >
                                    {{ csrf_field() }}
                                    <div class="row">
                           ...
                           <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <table id="example2" class="table table-bordered table-hover">
                                 ...
                                 <tbody>
                                    @foreach($manageactivationlist['details'] as $key2=>$manageactivationdetailslist)
                                    <tr>
                                       <td>{{ $key2+1 }}</td>
                                       <td>{{ $manageactivationdetailslist['from_date'] }}</td>
                                       <td>{{ $manageactivationdetailslist['to_date'] }}</td>
                                       <td>{{ $manageactivationdetailslist['credit_amount'] }}</td>
                                       <td>{{ $manageactivationdetailslist['intrest'] }}</td>
                                       <td>{{ $manageactivationdetailslist['intrest_amount'] }}</td>
                                       <td>{{ $manageactivationdetailslist['pay_amount'] }}</td>
                                       <td>{{ $manageactivationdetailslist['balance_amount'] }}</td>
                              ...
                              <form action="{{url('/add_activationdetails')}}" onsubmit="return validate_amount(event,{{ $manageactivationlist['id'] }})" method="post" >
                                 {{ csrf_field() }}
                                 <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <div class="form-group row">
                                          <label for="credit_amount" class="col-sm-4 col-form-label"><span style="color:red"></span>Credit Amount</label>
                                          <div class="col-sm-8">
                                       ...
                                       <div class="form-group row">
                                          <label for="current_date" class="col-sm-4 col-form-label"><span style="color:red"></span>Current Date</label>
                                          <div class="col-sm-8">
                                             <input readonly value="{{ $thisdate = date('Y-m-d'); }}" type="text"  class="form-control" name="current_date" placeholder="Current Date"/>
                                          </div>
                                       </div>
                                       <div class="form-group row">
                                          <label for="intrest" class="col-sm-4 col-form-label"><span style="color:red"></span>Interest %</label>
                                          <div class="col-sm-8">
                                             <input readonly value="{{ $manageactivationlist['intrest'] }}" type="text"  class="form-control" name="intrest" placeholder="Intrest"/>
                                          </div>
                                       </div>
                                       <div class="form-group row">
                                          <label for="intrest_amount" class="col-sm-4 col-form-label"><span style="color:red"></span>Interest Amount</label>
                                          <div class="col-sm-8">
                                       ...
                                       <div class="form-group row">
                                          <label for="pay_amount" class="col-sm-4 col-form-label Decimal"><span style="color:red"></span>Pay Amount</label>
                                          <div class="col-sm-8">
                                 ...
                                 <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								@if($manageactivationlist['credit_amount'] == 0)
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								@else
                                    <button type="submit" id="save" class="btn btn-primary">Submit</button>
								@endif
      ...
      <div class="modal-body">
         <div class="row">
            ...
            <div class="col-md-6">
               ...
               <input type="text"  class="form-control mb-3" name="measurement" id="measurement" placeholder="Measurement"/>
			   
               <input type="hidden" class="form-control" name="giveamound" id="giveamound" value="2000"/>
